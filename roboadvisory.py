...
st.markdown("""
    ...
    <div class="intro">
        ...
        <p>تم صنع هذه الأداة لمساعدتك في اتخاذ قرارك الاستثماري بشكل أفضل من خلال مقارنة بين مقدمي خدمات المستشارين الآلي في المملكة العربية السعودية تقوم الأداة بمحاكاة أداء المحافظ لكل شركة بناءً على أسعار الصناديق المختارة من قبل كل محفظة</p>
    </div>
...
if st.button("بسمك اللهم اموت واحيا"):
    trading_days = 252
    ...
    st.markdown("<p style=\"text-align: right; color: #FFFF00; font-family: 'Amiri', serif; font-size: 20px;\">مقارنة المحافظ ذات الاعلى مخاطر في كل شركة/p>", unsafe_allow_html=True)
    ...
    # st.markdown(f"<p style='text-align: right; color: #4A4A4A; font-family: \"Amiri\", serif; font-size: 18px;'>المحفظة ذات أعلى عائد هي المحفظة <b>{portfolio_highes}</b> بعائد %<b>{highestreturn}</b> المقدمة من <b>{portfolio_company}</b></p>", unsafe_allow_html=True)
    ...
    # st.markdown(f"<p style='text-align: right; color: #4A4A4A; font-family: \"Amiri\", serif; font-size: 18px;'>المحفظة ذات أعلى معامل بيتا هي المحفظة <b>{portfolio_beta}</b> يساوي<b>{highestbeta}</b> المقدمة من <b>{portfolio_companybeta}</b> وذلك يعني انها تتبع عائدالمؤشر بشكل افضل من منافسيها</p>", unsafe_allow_html=True)
    ...
    # st.markdown(f"<p style='text-align: right; color: #4A4A4A; font-family: \"Amiri\", serif; font-size: 18px;'>المحفظة ذات أقل انحراف معياري هي المحفظة <b>{portfolio_std}</b> يساوي %<b>{loweststd}</b> المقدمة من <b>{portfolio_companystd}</b></p>", unsafe_allow_html=True)
    st.markdown(f"""
